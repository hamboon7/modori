...
public class BazaarVO {
	...
	public BazaarVO(int num, String name, String img1, String img2, String img3, int stu_seller_num,
			int stu_buyer_num, int price, int sale, String category, String pro_condition, String sell_condition, String deal,
			String comment, String buyer_condition, String seller_condition, int score, float total_score) {
		super();
		this.num = num;
		this.name = name;
		this.img1 = img1;
	...
	public String toString() {
		return "num=" + num + ", name=" + name + ", img1=" + img1 + ", img2=" + img2 + ", img3=" + img3
				...
				+ ", sale=" + sale + ", category=" + category + ", pro_condition=" + pro_condition + ", sell_condition="
				+ sell_condition + ", deal=" + deal + ", comment=" + comment + ", buyer_condition=" + buyer_condition
				+ ", seller_condition=" + seller_condition + ", score=" + score + ", total_score=" + total_score;
	}
