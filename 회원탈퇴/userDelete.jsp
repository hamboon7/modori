	...
	<div class="login-wrap">
		<div class="login-html">
			<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label
				for="tab-1" class="tab">회원 탈퇴</label> <input id="tab-2"
			...
			<div class="login-form">
				<div class="sign-in-htm">
					...
					<form id="join" name="join" method="post"
						action="Controller?cmd=MyPageAction">

						<div class="form-group">
							<hr class="heading" />
							<div class="controls">
								<input id="pw" type="text" class="floatLabel" name="pw"><label
									for="pw">비밀번호</label>
							</div>
						</div>
						<input type="button" class="col-1-4" value="취소" onclick="javascript:window.location='myPage.jsp'">
						<input type="button" class="col-1-4" value="탈퇴하기" onclick="CheckForm();">
