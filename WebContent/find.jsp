		...
		<div class="login-html">
			...
			<div class="login-form">
				<div class="sign-in-htm">
					<form method="post" action="Controller?cmd=findAction">
						<div class="group">
							<label for="user" class="label">학번</label> <input id="user"
								type="text" class="input" name="id" data-toggle="tooltip" data-placement="bottom"
								title="학번을 입력하세요">
						</div>
						<div class="group">
							<label for="user" class="label">이메일</label> <input id="user"
								type="text" class="input" name="e-mail">
						</div>
				...
				<div class="sign-up-htm">
					<form method="post" action="Controller?cmd=findUpdateAction">
						<div class="group">
							<label for="user" class="label">학번</label> <input id="user"
						...
						<div class="group">
							<label for="pass" class="label">비밀번호</label> <input id="pass"
								type="password" class="input" data-type="password" name="pw">
						</div>
						<div class="group">
							<input type="submit" class="button" value="확인">
						</div>
