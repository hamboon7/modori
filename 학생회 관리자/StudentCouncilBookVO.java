...
public class StudentCouncilBookVO {
	...
	public StudentCouncilBookVO(int allCount, int allRental, int allBooking, int reservation_num, int book_num,
			int stu_num, Date rental_date, Date return_date, int book_condition, String book_name, String book_img, 
			int book_enroll_condition) {
		super();
	...
	public String toString() {
		return "allCount=" + allCount + ", allRental=" + allRental + ", allBooking=" + allBooking
				+ ", reservation_num=" + reservation_num + ", book_num=" + book_num + ", stu_num=" + stu_num
				+ ", rental_date=" + rental_date + ", return_date=" + return_date + ", book_condition=" + book_condition
				+ ", book_name=" + book_name + ", book_img=" + book_img + ", book_enroll_condition=" + book_enroll_condition;
	}
