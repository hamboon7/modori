...
<body>
	<nav
		...
		<div class="flex-row d-flex">
			<a class="navbar-brand mb-1" href="#">Modori</a>
		</div>
				...
				<ul class="nav flex-column pl-1">
					<li class="nav-item" id="menu"><a class="nav-link"
						...
						<ul class="list-unstyled flex-column pl-3 collapse" id="submenu1"
							aria-expanded="false">
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilAction&number=6">6회</a></li>
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilAction&number=5">5회</a></li>
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilAction&number=4">4회</a></li>
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilAction&number=3">3회</a></li>
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilAction&number=2">2회</a></li>
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilAction&number=1">1회</a></li>
						</ul></li>
					<li class="nav-item"><a class="nav-link" href="#submenu2"
						...
						<ul class="list-unstyled flex-column pl-3 collapse" id="submenu2"
							aria-expanded="false">
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilCountAction">재고관리</a></li>
							<li class="nav-item"><a class="nav-link" href="Controller?cmd=studentCouncilDamageAction&number=1">훼손관리</a></li>
						</ul></li>
					<li class="logout nav-item"><a class="nav-link" href="Controller?cmd=logoutAction">Logout</a></li>
				</ul>
			</div>
			<!--/col-->

			<div class="col-md-9 col-lg-10 main">
				<c:forEach items="${studentBazaarCalData}" var="studentVO">
						...
						<div class="col-xl-6 col-lg-6">
							<div class="card card-inverse card-success">
								<div class="card-block bg-success">
									...
									<h2 class="display-1">${studentVO.bazaar_count}</h2>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6">
				...
				<div class="card-deck-wrapper mb-3">
					<div class="card-deck">
						<c:forEach items="${studentBazaarData}" var="studentVO">
							<div class="card">
							<img class="card__image" src="img/${studentVO.img1}" height="300" />
							<div class="card-body">
								<h4 class="card-title">
								...
								<h5>
									판매자 : <c:out value="${studentVO.stu_seller_num}" /><br>
									<c:choose>
