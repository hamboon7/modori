	...
	<div class="container-fluid" id="main">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				<div>
					<h5 class="enroll">바자회 등록</h5>
					<form method="post" action="Controller?cmd=studentCouncilBazzarEnrollAction">      
					  <input name="name" type="text" class="feedback-input" placeholder="6회 바자회" />   
					  <input name="bank" type="text" class="feedback-input" placeholder="은행" />
					  <input name="account" type="text" class="feedback-input" placeholder="계좌번호" />
					  <input name="startDate" type="date" class="feedback-input" />
					  <input name="endDate" type="date" class="feedback-input" />
